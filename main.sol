...
contract Capstone {
    ...
    function rentLand ( uint256 id, uint256 start_date, uint256 end_date ) public payable {
        ...
        uint256 expected_price = lands[id].rent_price * period / 30;
        require(expected_price <= msg.value, "Insufficient money");
        payable(msg.sender).transfer(msg.value - expected_price);
